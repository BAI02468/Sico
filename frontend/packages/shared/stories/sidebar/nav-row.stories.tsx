...
// `NavRow`/`RailNavRow`/`NavBadge` are presentational primitives composed into
// interactive sidebar rows (e.g. the Notification nav item's popover trigger).
// They take a caller-supplied `render` element; these stories use a plain
