...
const components: Components = {
  ...
  ul: ({ children }) => (
    <ul className="text-foreground-primary leading-body list-disc py-2 ps-6 first:pt-0 last:pb-0">
      {children}
    </ul>
  ),
  ol: ({ children }) => (
    <ol className="text-foreground-primary leading-body list-decimal py-2 ps-6 first:pt-0 last:pb-0">
      {children}
    </ol>
  ),
  li: ({ children }) => <li className="pb-1 last:pb-0">{children}</li>,
  blockquote: ({ children }) => (
    <blockquote className="text-foreground-secondary border-divider border-s-2 py-2 ps-4 first:pt-0 last:pb-0">
      {children}
    </blockquote>
  ),
