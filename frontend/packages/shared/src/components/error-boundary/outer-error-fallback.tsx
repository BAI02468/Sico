 ...
 *
 * Copy is intentionally hardcoded English, NOT i18n: this boundary sits
 * OUTSIDE `I18nProvider` (app.tsx → ErrorBoundary → RootProviders →
 * I18nProvider), so `useLingui()`/`<Trans>` would read a null LinguiContext
 * and throw — crashing the very fallback meant to catch a catastrophic
 * provider-init failure. The inner fallback runs inside the providers and can
 * localize; this one cannot.
 *
