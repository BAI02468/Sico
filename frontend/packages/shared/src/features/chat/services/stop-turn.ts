...
import { STOP_FAILED_COPY } from "../constants";
...
// Message descriptor (module scope, non-React) resolved with `i18n._()` at the
// toast — defined in constants.ts alongside SEND_FAILED_COPY.
...
export async function stopTurn(
  ...
  if (turnId !== undefined) {
    try {
      ...
      ctx.toastError(i18n._(STOP_FAILED_COPY));
      return;
    }
  }
