    ...
    <div className="flex flex-col gap-1">
      <div className="flex h-9 items-center justify-between gap-2 pr-1 pl-2">
        <span className="text-foreground-tertiary truncate text-xs font-medium tracking-wider uppercase">
          <Trans id="sidebar.dwSection.title">Digital Workers</Trans>
        </span>
        <Link
          to="/digital-worker"
          aria-label={t({
            id: "sidebar.dwSection.viewAllAriaLabel",
            message: "View all digital workers",
          })}
        ...
        >
          <Trans id="sidebar.dwSection.viewAll">View all</Trans>
