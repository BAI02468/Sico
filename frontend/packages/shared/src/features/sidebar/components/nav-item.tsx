...
// `label` widens the data shape's `string` to `ReactNode` so sico's own rows
// can pass a `<Trans>` element; downstream extras still pass a plain string.
type NavItemProps = Omit<NavItemData, "label"> & {
