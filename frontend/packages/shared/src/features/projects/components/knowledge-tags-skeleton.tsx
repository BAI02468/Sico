...
export function KnowledgeTagsSkeleton(): React.JSX.Element {
  ...
  const headers = [
    t({ id: "projects.knowledgeTagsSkeleton.tag", message: "KNOWLEDGE TAG" }),
    t({
      id: "projects.knowledgeTagsSkeleton.description",
      message: "DESCRIPTION",
    }),
  ];
  ...
  return (
    <div
      role="status"
      aria-label={t({
        id: "projects.knowledgeTagsSkeleton.loading",
            ...
            <TableHeader>
              <TableRow className="h-13">
                ...
                <TableHead className="h-13 px-6 text-right text-sm">
                  <Trans id="projects.knowledgeTagsSkeleton.actions">
                    ACTIONS
                  </Trans>
                </TableHead>
              </TableRow>
